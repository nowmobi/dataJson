...
# 读取原始数据
with open('games7-data.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
db_files = ['db1.json', 'db2.json', 'db3.json', 'db4.json', 'db5.json', 'db6.json']
...
for db_file in db_files:
    ...
    # 写入到对应的文件
    with open(f'games7/{db_file}', 'w', encoding='utf-8') as f:
